          ...
          !(function (t, o) {
            ...
            (r.prototype.init = function () {
              ...
              var o = 1,
                ...
                a = function t(r, a, l, s) {
                  ...
                  u = e.core.s.dynamic
                    ...
                    : e.core.items[l].getAttribute("data-width") ||
                      a.naturalWidth ||
                      n;
                  var c;
              ...
              (r.prototype.getPossibleDragCords = function (e, t) {
                var o =
                    (this.core.outer.querySelector(".lg").clientHeight -
                      this.getImageSize(e, t, "y")) /
                    2,
                  r = Math.abs(
                    this.getImageSize(e, t, "y") *
                      Math.abs(e.getAttribute("data-scale")) -
                      this.core.outer.querySelector(".lg").clientHeight +
                      o
                  ),
                  i =
                    (this.core.outer.querySelector(".lg").clientWidth -
                      this.getImageSize(e, t, "x")) /
                    2,
                  a = Math.abs(
                    this.getImageSize(e, t, "x") *
                      Math.abs(e.getAttribute("data-scale")) -
                ...
                return 90 === t
                  ? { minY: i, maxY: a, minX: o, maxX: r }
                  : { minY: o, maxY: r, minX: i, maxX: a };
              }),
              (r.prototype.getDragAllowedAxises = function (e, t) {
                var o =
                    this.getImageSize(e, t, "y") *
                      e.getAttribute("data-scale") >
                    this.core.outer.querySelector(".lg").clientHeight,
                  r =
                    this.getImageSize(e, t, "x") *
                      e.getAttribute("data-scale") >
                  ...
                  utils.on(e.core.___slide[n], "touchstart.lg", function (o) {
                    if (utils.hasClass(e.core.outer, "lg-zoomed")) {
                      ...
                      (a = n.allowY),
                        ...
                        (i || a) &&
                          (o.preventDefault(),
                          (t = e.getSwipeCords(o, Math.abs(l))));
                    }
                  });
                      ...
                      n.preventDefault(),
                        ...
                        (g = a
                          ? -Math.abs(u.getAttribute("data-y")) +
                            (o.y - t.y) * e.getModifier(l, "Y", s)
                          : -Math.abs(u.getAttribute("data-y"))),
                        (c = i
                          ? -Math.abs(u.getAttribute("data-x")) +
                            (o.x - t.x) * e.getModifier(l, "X", s)
                          : -Math.abs(u.getAttribute("data-x"))),
                        (Math.abs(o.x - t.x) > 15 ||
                          Math.abs(o.y - t.y) > 15) &&
                          (e.core.s.useLeftForZoom
                ...
                utils.on(window, "mousemove.lgzoom", function (u) {
                    ...
                    (i = !0),
                      ...
                      (d = l
                        ? -Math.abs(c.getAttribute("data-y")) +
                          (o.y - t.y) * e.getModifier(s, "Y", n)
                        : -Math.abs(c.getAttribute("data-y"))),
                      (g = a
                        ? -Math.abs(c.getAttribute("data-x")) +
                          (o.x - t.x) * e.getModifier(s, "X", n)
                        : -Math.abs(c.getAttribute("data-x"))),
                      e.core.s.useLeftForZoom
                  ...
                  utils.on(window, "mouseup.lgzoom", function (n) {
                    r &&
                      ...
                      !i ||
                        (t.x === o.x && t.y === o.y) ||
                        ((o = e.getDragCords(n, Math.abs(s))),
                        e.touchendZoom(t, o, a, l, s)),
                      (i = !1)),
                      utils.removeClass(e.core.outer, "lg-grabbing"),
                      utils.addClass(e.core.outer, "lg-grab");
                  });
              ...
              (r.prototype.touchendZoom = function (e, t, o, r, i) {
                var a = this,
                  l =
                    a.core.___slide[a.core.index].querySelector(".lg-img-wrap"),
                  s = a.core.___slide[a.core.index].querySelector(".lg-object"),
                  n =
                    a.core.___slide[a.core.index].querySelector(
                      ".lg-img-rotate"
                    ),
                  u =
                    -Math.abs(l.getAttribute("data-x")) +
                    (t.x - e.x) * a.getModifier(i, "X", n),
                  c =
                    -Math.abs(l.getAttribute("data-y")) +
                    (t.y - e.y) * a.getModifier(i, "Y", n),
                ...
                (Math.abs(t.x - e.x) > 15 || Math.abs(t.y - e.y) > 15) &&
                  ...
                  o &&
                    (u <= -g.maxX
                      ...
                      : u >= -g.minX && (u = -g.minX)),
                  r
                    ? l.setAttribute("data-y", Math.abs(c))
                    : (c = -Math.abs(l.getAttribute("data-y"))),
                  o
                    ? l.setAttribute("data-x", Math.abs(u))
                    : (u = -Math.abs(l.getAttribute("data-x"))),
