...
Plugin.prototype.loadContent = function (index, rec, delay) {
  ...
  if (_this.s.dynamic) {
    ...
    if (_this.items[index].querySelector("img")) {
      _alt =
        _alt || _this.items[index].querySelector("img").getAttribute("alt");
    }
...
Plugin.prototype.touchEnd = function (distance) {
  ...
  for (var i = 0; i < this.___slide.length; i++) {
    if (
      !utils.hasClass(this.___slide[i], "lg-current") &&
      !utils.hasClass(this.___slide[i], "lg-prev-slide") &&
      !utils.hasClass(this.___slide[i], "lg-next-slide")
    ) {
  ...
  setTimeout(function () {
    if (
      !utils.hasClass(_this.outer, "lg-dragging") &&
      ...
      utils.on(_this.___slide[i], "mousedown.lg", function (e) {
        ...
        if (!utils.hasClass(_this.outer, "lg-zoomed")) {
          if (
            ...
            utils.hasClass(e.target, "lg-video-play")
          ) {
            e.preventDefault();
...
Plugin.prototype.closeGallery = function () {
  ...
  if (_this.s.closable) {
    ...
    utils.on(_this.outer, "mousedown.lg", function (e) {
      if (
        utils.hasClass(e.target, "lg-outer") ||
        utils.hasClass(e.target, "lg-item") ||
        utils.hasClass(e.target, "lg-img-wrap")
      ) {
        mousedown = true;
      } else {
        mousedown = false;
    ...
    utils.on(_this.outer, "mouseup.lg", function (e) {
      if (
        utils.hasClass(e.target, "lg-outer") ||
        utils.hasClass(e.target, "lg-item") ||
        (utils.hasClass(e.target, "lg-img-wrap") && mousedown)
      ) {
